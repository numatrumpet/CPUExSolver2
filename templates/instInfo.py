...
def constructInstInfo(config):
  ...
  return [
    ...
    {'type' : 'FINV', 'formBin' : 'R', 'formAsm' : ['FRD', 'FRS'], 'code' : ["%(arg0)s = myfinv(%(arg1)s)"]},
    {'type' : 'FINVN', 'formBin' : 'R', 'formAsm' : ['FRD', 'FRS'], 'code' : ["%(arg0)s = myfinv(-%(arg1)s)"]},
    {'type' : 'FSQRT', 'formBin' : 'R', 'formAsm' : ['FRD', 'FRS'], 'code' : ["%(arg0)s = myfsqrt(%(arg1)s)"]},
    {'type' : 'FABS', 'formBin' : 'R', 'formAsm' : ['FRD', 'FRS'], 'code' : ["%(arg0)s = myfabs(%(arg1)s)"]},
    {'type' : 'FMOV', 'formBin' : 'R', 'formAsm' : ['FRD', 'FRS'], 'code' : ["%(arg0)s = %(arg1)s"]},
    {'type' : 'FNEG', 'formBin' : 'R', 'formAsm' : ['FRD', 'FRS'], 'code' : ["%(arg0)s = myfneg(%(arg1)s)"]},
    {'type' : 'FLOOR', 'formBin' : 'R', 'formAsm' : ['FRD', 'FRS'], 'code' : ["%(arg0)s = myfloor(%(arg1)s)"]},
    {'type' : 'FSIN', 'formBin' : 'R', 'formAsm' : ['FRD', 'FRS'], 'code' : ["%(arg0)s = myfsin(%(arg1)s)"]},
    {'type' : 'FCOS', 'formBin' : 'R', 'formAsm' : ['FRD', 'FRS'], 'code' : ["%(arg0)s = myfcos(%(arg1)s)"]},
    {'type' : 'FTAN', 'formBin' : 'R', 'formAsm' : ['FRD', 'FRS'], 'code' : ["%(arg0)s = myftan(%(arg1)s)"]},
    {'type' : 'FATAN', 'formBin' : 'R', 'formAsm' : ['FRD', 'FRS'], 'code' : ["%(arg0)s = myfatan(%(arg1)s)"]},
    ...
    {'type' : 'SETLO', 'formBin' : 'I', 'formAsm' : ['IRT', 'IMM'], 'code' : ["%(arg0)s = (%(arg0)s & 0xffff0000) | (IMM & 0xffff)"]},
    {'type' : 'SETHI', 'formBin' : 'I', 'formAsm' : ['IRT', 'IMM'], 'code' : ["%(arg0)s = ((uint32_t)IMM << 16) | (%(arg0)s & 0xffff)"]},
    {'type' : 'FSETLO', 'formBin' : 'I', 'formAsm' : ['FRT', 'IMM'], 'code' : ["%(arg0)s = (%(arg0)s & 0xffff0000) | (IMM & 0xffff)"]},
    {'type' : 'FSETHI', 'formBin' : 'I', 'formAsm' : ['FRT', 'IMM'], 'code' : ["%(arg0)s = ((uint32_t)IMM << 16) | (%(arg0)s & 0xffff)"]},
    ...
    {'type' : 'INPUTBYTE', 'formBin' : 'R', 'formAsm' : ['IRT'], 'code' : ["%(arg0)s = getchar() & 0xff"]},
    {'type' : 'INPUTWORD', 'formBin' : 'R', 'formAsm' : ['IRT'], 'code' : ["%(arg0)s = (getchar() & 0xff) << 24", "%(arg0)s |=(getchar() & 0xff) << 16", "%(arg0)s |= (getchar() & 0xff) << 8", "%(arg0)s |= (getchar() & 0xff)"]},
    {'type' : 'INPUTFLOAT', 'formBin' : 'R', 'formAsm' : ['FRT'], 'code' : ["%(arg0)s = (getchar() & 0xff) << 24", "%(arg0)s |=(getchar() & 0xff) << 16", "%(arg0)s |= (getchar() & 0xff) << 8", "%(arg0)s |= (getchar() & 0xff)"]},
    {'type' : 'OUTPUTBYTE', 'formBin' : 'R', 'formAsm' : ['IRT'], 'code' : ["cout << (char)%(arg0)s << flush"]},
    {'type' : 'OUTPUTWORD', 'formBin' : 'R', 'formAsm' : ['IRT'], 'code' : ["cout << (int32_t)%(arg0)s << flush"]},
    {'type' : 'OUTPUTFLOAT', 'formBin' : 'R', 'formAsm' : ['FRT'], 'code' : ["cout << (float)%(arg0)s << flush"]},
